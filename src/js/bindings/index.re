...
external chain2:
  (
    [@bs.unwrap] [ | `Pipe(Pipe.t) | `TransformStream(TransformStream.t)],
    [@bs.unwrap] [ | `Pipe(Pipe.t) | `TransformStream(TransformStream.t)]
  ) =>
  Pipe.t =
  "default";
...
external sequence: unit => Pipe.t = "default";

[@bs.module "../../pipes/build/pipes/core/tee"]
external tee: 'a => 'b = "default";
